...
export const SEED_ITEMS: Item[] = [
  ...
  offer('u_azhe', '宜家 POÄNG 单人扶手椅', '家具', '9成新', '200-500', '搬家带不走，桦木贴面，坐垫可拆洗，上海自提。', 26),
  offer('u_azhe', '实木书桌 120×60', '家具', '8成新', '500-2000', '橡木，桌面有一处浅划痕，其余完好，需自行拆装。', 64, 2),
  ...
  offer('u_mumu', '书架 五层 80cm', '家具', '9成新', '200-500', '租房买的，结实没晃，搬走懒得带走，可拆。', 38),
  ...
  offer('u_xiaoyu', '北欧风落地灯', '家具', '95新', '200-500', '三色调光，布艺灯罩，灯泡一起送。', 88),
